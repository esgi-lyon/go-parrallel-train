...
// checks if the TaskCrawlerParamsResultsPerPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskCrawlerParamsResultsPerPage{}

// TaskCrawlerParamsResultsPerPage struct for TaskCrawlerParamsResultsPerPage
type TaskCrawlerParamsResultsPerPage struct {
...
func NewTaskCrawlerParamsResultsPerPage() *TaskCrawlerParamsResultsPerPage {
	this := TaskCrawlerParamsResultsPerPage{}
	return &this
}
...
func (o TaskCrawlerParamsResultsPerPage) MarshalJSON() ([]byte, error) {
...
func (o TaskCrawlerParamsResultsPerPage) ToMap() (map[string]interface{}, error) {
...
type NullableTaskCrawlerParamsResultsPerPage struct {
	value *TaskCrawlerParamsResultsPerPage
	isSet bool
}

func (v NullableTaskCrawlerParamsResultsPerPage) Get() *TaskCrawlerParamsResultsPerPage {
	return v.value
}

func (v *NullableTaskCrawlerParamsResultsPerPage) Set(val *TaskCrawlerParamsResultsPerPage) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskCrawlerParamsResultsPerPage) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskCrawlerParamsResultsPerPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskCrawlerParamsResultsPerPage(val *TaskCrawlerParamsResultsPerPage) *NullableTaskCrawlerParamsResultsPerPage {
	return &NullableTaskCrawlerParamsResultsPerPage{value: val, isSet: true}
}

func (v NullableTaskCrawlerParamsResultsPerPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskCrawlerParamsResultsPerPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
